<div id="custom" class="pop-up closed">
    ...
    <div class="settings">
	<form id="frm_custom" action="library/settings_controller.php" method="POST">
		...
		<span class="opt_title"><?= $T->__("Points player 2") ?></span>
		<span class="opt_options">
		...
		<span class="opt_title"><?= $T->__("Points player 3") ?></span>
		<span class="opt_options">
		...
		<span class="opt_title"><?= $T->__("Points player 4") ?></span>
		<span class="opt_options">
		...
		<span class="opt_title"><?= $T->__("Points player 5") ?></span>
		<span class="opt_options">
	    ...
	    <div class="setting">
		<span class="opt_title"><?= $T->__("Current wind") ?></span>
		  <span class="opt_options">
	    ...
	    <div class="confirm">
		<button type="button" id="btn_cstm_cancel"><?= $T->__("Cancel") ?></button>
		<button type="button" id="btn_cstm_start"><?= $T->__("Start") ?></button>
	    </div>
	</form>
    </div>
</div>
