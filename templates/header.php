<div class="header">
   ...
   <?php if ($mj->is_logged_in()): ?>
     ...
     <button id="btn_saveload"><span class="web"><?= $T->__("Load game") ?>&hellip;</span><span class="phone">&hellip;</span></button>
   <?php else: ?>
     <button id="btn_show_login"><span class="web"><?= $T->__("Login") ?></span><span class="phone">LI</span></button>
   <?php endif; ?>
     <button id="btn_show_options"><span class="web"><?= $T->__("New game") ?>&hellip;</span><span class="phone">&hellip;</span></button>
</div>
